                  ...
                  {file.type === 'image' ? (
                    <div className="relative">
                      ...
                      <Button
                        ...
                        variant="ghost"
                        size="icon"
                        className="absolute top-1 right-1 h-2 w-2 rounded-full p-0 bg-black/80 hover:bg-black shadow-md flex items-center justify-center transition-all"
                    ...
                    <div className="relative">
                      ...
                      <Button
                        ...
                        variant="ghost"
                        size="icon"
                        className="absolute top-1 right-1 h-4 w-4 rounded-full p-0 bg-black/80 hover:bg-black shadow-md flex items-center justify-center transition-all"
                        onClick={() => setSelectedFiles(prev => prev.filter(f => f.id !== file.id))}
                      >
