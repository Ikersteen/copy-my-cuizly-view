                ...
                <div key={file.id} className="relative inline-block">
                  {file.type === 'image' ? (
                    <img 
                      src={file.data} 
                      alt={file.name} 
                      className="max-h-20 md:max-h-32 rounded-lg border border-border"
                    />
                  ) : (
                  ...
                  <Button
                    ...
                    variant="ghost"
                    size="sm"
                    className="absolute -top-1 -right-1 h-[18px] w-[18px] rounded-full p-0 bg-black hover:bg-black/80 text-white text-base font-bold leading-none flex items-center justify-center"
