                  ...
                  {file.type === 'image' ? (
                    <div className="relative">
                      ...
                      <Button
                        ...
                        variant="ghost"
                        size="sm"
                        className="absolute -top-1.5 -right-1.5 h-4 w-4 rounded-full p-0 bg-black hover:bg-gray-900 text-white shadow-lg flex items-center justify-center md:h-1 md:w-1 lg:h-1 lg:w-1"
