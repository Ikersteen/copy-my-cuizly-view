                  ...
                  {file.type === 'image' ? (
                    <div className="relative">
                      ...
                      <Button
                        ...
                        variant="ghost"
                        size="sm"
                        className="absolute -top-1.5 -right-1.5 h-4 w-4 rounded-full p-0 bg-black hover:bg-gray-900 text-white shadow-lg flex items-center justify-center md:h-5 md:w-5 lg:h-[18px] lg:w-[18px]"
