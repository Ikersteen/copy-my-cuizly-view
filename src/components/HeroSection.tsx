  ...
  return (
    <section className="bg-background py-16 md:py-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
        ...
        {/* Subtitle */}
        <p className="text-lg md:text-xl text-cuizly-neutral max-w-2xl mx-auto mb-8 md:mb-12 px-4">
          Intelligence artificielle. Recommandations personnalisées.<br className="hidden sm:block" />
          Les meilleures adresses de Montréal selon vos goûts.
        </p>
