...
-- We already have the secure RPC function which is sufficient
DROP VIEW IF EXISTS public.restaurants_public;

-- Find and fix the remaining function without search_path
-- Fix the send_waitlist_confirmation_email function 
